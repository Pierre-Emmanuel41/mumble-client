...
public class MumbleCommunicationProtocolVersionSetPostEvent extends MumbleServerEvent {
	 ...
	 */
	public MumbleCommunicationProtocolVersionSetPostEvent(IPlayerMumbleServer server, IMumbleMessage request, float version, AbstractMumbleTcpConnection<?> connection) {
		super(server);
