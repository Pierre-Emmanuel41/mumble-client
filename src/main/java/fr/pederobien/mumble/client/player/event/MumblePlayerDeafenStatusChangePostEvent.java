...
public class MumblePlayerDeafenStatusChangePostEvent extends MumblePlayerEvent {
	 ...
	 */
	public MumblePlayerDeafenStatusChangePostEvent(IPlayer player, boolean oldDeafen) {
		super(player);
