...
public class MumblePlayerGameAddressChangePostEvent extends MumbleMainPlayerEvent {
	 ...
	 */
	public MumblePlayerGameAddressChangePostEvent(IMainPlayer player, InetSocketAddress oldGameAddress) {
		super(player);
