...
public class PlayerPositionChangePreEvent extends MainPlayerEvent implements ICancellable {
	 ...
	 */
	public PlayerPositionChangePreEvent(IMainPlayer player, double x, double y, double z, double yaw, double pitch, Consumer<IResponse> callback) {
		super(player);
		this.x = x;
		this.y = y;
		this.z = z;
