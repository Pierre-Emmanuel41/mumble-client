...
public class MumbleChannelPlayerListPlayerRemovePreEvent extends MumbleChannelPlayerListEvent implements ICancellable {
	 ...
	 */
	public MumbleChannelPlayerListPlayerRemovePreEvent(IChannelPlayerList list, IPlayer player, Consumer<IResponse> callback) {
		super(list);
		this.player = player;
