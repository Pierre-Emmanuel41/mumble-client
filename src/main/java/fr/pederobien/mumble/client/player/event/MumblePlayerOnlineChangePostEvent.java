...
public class MumblePlayerOnlineChangePostEvent extends MumbleMainPlayerEvent {
	 ...
	 */
	public MumblePlayerOnlineChangePostEvent(IMainPlayer player, boolean oldOnline) {
		super(player);
