...
public class MumbleSoundModifierListSoundModifierAddPostEvent extends MumbleSoundModifierListEvent {
	 ...
	 */
	public MumbleSoundModifierListSoundModifierAddPostEvent(ISoundModifierList list, ISoundModifier soundModifier) {
		super(list);
