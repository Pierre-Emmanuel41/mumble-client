...
public class MumbleServerLeavePreEvent extends MumbleServerEvent implements ICancellable {
	 ...
	 */
	public MumbleServerLeavePreEvent(IPlayerMumbleServer server, Consumer<IResponse> callback) {
		super(server);
