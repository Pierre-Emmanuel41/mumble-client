...
public class MumblePlayerDeafenStatusChangePreEvent extends MumblePlayerEvent implements ICancellable {
	 ...
	 */
	public MumblePlayerDeafenStatusChangePreEvent(IPlayer player, boolean newDeafen, Consumer<IResponse> callback) {
		super(player);
