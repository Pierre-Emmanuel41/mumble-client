...
public class MumbleChannelListChannelRemovePreEvent extends MumbleChannelListEvent implements ICancellable {
	 ...
	 */
	public MumbleChannelListChannelRemovePreEvent(IChannelList list, String name, Consumer<IResponse> callback) {
		super(list);
		this.name = name;
