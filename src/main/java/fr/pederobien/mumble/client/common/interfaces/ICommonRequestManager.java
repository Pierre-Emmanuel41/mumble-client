...
public interface ICommonRequestManager<T extends ICommonChannel<?, ?>, U extends ICommonSoundModifier<?>, V extends ICommonPlayer, W extends ICommonParameter<?>> {
	 ...
	 */
	IMumbleMessage onPlayerOnlineChange(V player, boolean newOnline);
	 ...
	 */
	IMumbleMessage onPlayerNameChange(V player, String newName);
	 ...
	 */
	IMumbleMessage onPlayerGameAddressChange(V player, InetSocketAddress newGameAddress);
	 ...
	 */
	IMumbleMessage onPlayerAdminChange(V player, boolean newAdmin);
	 ...
	 */
	IMumbleMessage onPlayerPositionChange(V player, double x, double y, double z, double yaw, double pitch);
