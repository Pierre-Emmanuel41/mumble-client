...
public abstract class RequestManager extends AbstractRequestManager<IChannel, ISoundModifier, IPlayer, IParameter<?>, IExternalMumbleServer> implements IRequestManager {
	 ...
	 */
	public RequestManager(IExternalMumbleServer server, float version) {
